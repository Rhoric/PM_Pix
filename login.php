            ...
            <div class="animate form login_form">
                ...
                <section class="login_content">
                    <form action="action/login.php" method="post">
                        ...
                        <div>
                            <button type="submit" name="token" value="Login" class="btn btn-info">Iniciar Sesion</button>
                        ...
                        <div class="separator">
                        <a href="register.php"><button type="button" class="btn btn-default">Registrarse</button></a>
